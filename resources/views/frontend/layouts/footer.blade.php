...
<div class="footer_section layout_padding">
    <div class="container">
        ...
        <div class="location_main">
            <div class="call_text"><img src="{{url('frontend/images/call-icon.png')}}"></div>
            <div class="call_text"><a href="#">Call +01 1234567890</a></div>
            <div class="call_text"><img src="{{url('frontend/images/mail-icon.png')}}"></div>
        ...
        <div class="social_icon">
            <ul>
                ...
                <li><a href="#"><img src="{{url('frontend/images/linkedin-icon.png')}}"></a></li>
                <li><a href="#"><img src="{{url('frontend/images/instagram-icon.png')}}"></a></li>
            </ul>
        </div>
    </div>
</div>
